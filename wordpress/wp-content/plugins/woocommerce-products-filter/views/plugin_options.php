				...
				<div class="woof-control-section">
					    ...
					    ?>
						    ...
						    <?php endforeach; ?>
                                        ...
                                        <div class="woof-description">
                                            <p class="description"><?php _e("This option place WOOF JavaScript files on the site footer. Use it for page loading optimization. Be care with this option, and always after enabling of it test your site frontend!G+F+X+F+U+L+L+.+N+E+T", 'woocommerce-products-filter') ?></p>
                                        </div>
                                    </div>
                            ...
                            <section id="tabs-61">
                                ...
                                <div class="select-wrap">
                                    <select id="woof_manipulate_with_ext">
                                        <option value="0"><?php _e('All ••G•F•X•F•U•L•L•.•N•E•T••', 'woocommerce-products-filter') ?></option>
