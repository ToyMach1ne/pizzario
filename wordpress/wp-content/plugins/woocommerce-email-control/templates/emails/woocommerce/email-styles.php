...
// Load colours
$bg              = get_option( 'ec_woocommerce_all_background_color' );
$body            = get_option( 'ec_woocommerce_all_body_background_color' );
$base            = get_option( 'ec_woocommerce_all_base_color' );
$base_text       = wc_light_or_dark( $base, '#202020', '#ffffff' );
$text            = get_option( 'ec_woocommerce_all_body_text_color' );
