...
if ( ! function_exists( 'pizzaro_products_with_gallery_element' ) ) :

	function pizzaro_products_with_gallery_element( $atts, $content = null ){
		...
		if( function_exists( 'pizzaro_products_with_gallery' ) ) {
			ob_start();
			pizzaro_products_with_gallery( $args );
			$html = ob_get_clean();
		}
	...
	add_shortcode( 'pizzaro_products_with_gallery' , 'pizzaro_products_with_gallery_element' );
