	...
	<div class="document-totals">
		<table class="invoice-totals">
			<tr class="invoice-details-subtotal">
				<td class="left-content column-product"><?php _e( "Subtotal", 'yith-woocommerce-pdf-invoice' ); ?></td>
				<td class="right-content column-total"><?php echo wc_price( $invoice_details->get_order_subtotal( YITH_PDF_Invoice()->subtotal_incl_discount ) ); ?></td>
			</tr>
			...
			<?php if ( ywpi_is_visible_order_discount( $document ) ): ?>
				<tr>
					...
					<td class="right-content column-total"><?php echo wc_price( $invoice_details->get_order_discount() ); ?></td>
				</tr>
			<?php endif; ?>
			...
			<?php if ( 'yes' == get_option( 'woocommerce_calc_taxes' ) ) :
				foreach ( $invoice_details->get_order_taxes() as $code => $tax ) : ?>
					<tr class="invoice-details-vat">
						...
						<td class="right-content column-total"><?php echo wc_price( $tax->amount ); ?></td>
					</tr>
				<?php endforeach; ?>
			<?php endif; ?>
			...
			<tr class="invoice-details-total">
				...
				<td class="right-content column-total"><?php echo wc_price( $invoice_details->get_order_total() ); ?></td>
			</tr>
		</table>
	</div>
<?php endif; ?>