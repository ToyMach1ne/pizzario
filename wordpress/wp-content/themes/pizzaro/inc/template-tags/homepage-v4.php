...
function pizzaro_get_default_home_v4_options() {
	$home_v4 = array(
		'ti'	=> array(
			'is_enabled'		=> 'yes',
			'animation'			=> '',
	...
	return apply_filters( 'pizzaro_get_default_home_v4_options', $home_v4 );
}

function pizzaro_get_home_v4_meta( $merge_default = true ) {
	global $post;

	if ( isset( $post->ID ) ){

		$home_v4_options = json_decode( get_post_meta( $post->ID, '_home_v4_options', true ), true );

		if ( $merge_default ) {
			$default_options = pizzaro_get_default_home_v4_options();
			$home_v4 = wp_parse_args( $home_v4_options, $default_options );
		} else {
			$home_v4 = $home_v4_options;
		}

		return apply_filters( 'pizzaro_home_v4_meta', $home_v4, $post );
	}
}

if ( ! function_exists( 'pizzaro_tiles_v4' ) ) {
	/**
	 * Tiled Block
	 */
	function pizzaro_tiles_v4() {
		$home_v4 	= pizzaro_get_home_v4_meta();
		$ti_options = $home_v4['ti'];
...
if ( ! function_exists( 'pizzaro_banners_1_v4' ) ) {
	/**
	 * Banners Block
	 */
	function pizzaro_banners_1_v4() {
		$home_v4 	= pizzaro_get_home_v4_meta();
...
if ( ! function_exists( 'pizzaro_banners_2_v4' ) ) {
	/**
	 * Banners Block
	 */
	function pizzaro_banners_2_v4() {
		$home_v4 	= pizzaro_get_home_v4_meta();
