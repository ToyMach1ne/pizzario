...
if ( ! function_exists( 'pizzaro_cart_link' ) ) {
	...
	function pizzaro_cart_link() {
		?>
			<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'pizzaro' ); ?>">
				<span class="amount"><span class="price-label"><?php esc_attr_e( 'Ваша корзина', 'pizzaro' ); ?></span><?php echo wp_kses_data( WC()->cart->get_cart_subtotal() ); ?></span> <span class="count"><?php echo wp_kses_data( WC()->cart->get_cart_contents_count() );?></span>
			</a>
		<?php
	}
}
	...
	function pizzaro_header_cart_v2() {
		if ( is_woocommerce_activated() && pizzaro_shop_catalog_mode() == false && apply_filters( 'pizzaro_show_header_cart_v2', true ) ) {
			...
			<ul class="site-header-cart-v2 menu">
				<li class="<?php echo esc_attr( $class ); ?>">
					<a href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'pizzaro' ); ?>">
						<i class="po po-scooter"></i>
						<span>
							<?php if ( WC()->cart->get_cart_contents_count() > 0 ) {
								echo esc_html__( 'Go to Your Cart', 'pizzaro' );
							} else {
								echo esc_html__( 'Корзина Пуста', 'pizzaro' );
							} ?>
						</span>
					</a>
					<ul class="sub-menu">
...
if ( ! function_exists( 'pizzaro_handheld_footer_bar_cart_link' ) ) {
	...
	function pizzaro_handheld_footer_bar_cart_link() {
		?>
			<a class="footer-cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'pizzaro' ); ?>">
