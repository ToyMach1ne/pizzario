<?php
/**
 * The template for displaying the homepage v4.
 *
 * This page template will display any functions hooked into the `pizzaro_homepage_v4` action.
 *
