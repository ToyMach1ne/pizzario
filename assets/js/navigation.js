...
(function( $ ){
	...
	if ( jQuery( window ).width() > 1024 ) {
		$('.page-template-template-homepage-v6 .primary-navigation ul li.menu-item-has-children, .page-template-template-homepage-v6 .secondary-navigation ul li.menu-item-has-children').on('mouseover', function() {
			var $menuItem = $(this),
